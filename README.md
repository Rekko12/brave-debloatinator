...
* Disables the password manager (I recommend using a third party password manager such as [Proton Pass](https://proton.me/pass) that isn't tied to Brave sync or any one browser.)
